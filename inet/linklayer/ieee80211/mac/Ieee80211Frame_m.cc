...
uint16_t Ieee80211DataOrMgmtHeader::getSequenceNumber() const
{
    return this->sequenceNumber;
}

void Ieee80211DataOrMgmtHeader::setSequenceNumber(uint16_t sequenceNumber)
{
    handleChange();
...
unsigned int Ieee80211AddbaRequestDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_startingSequenceNumber
    };
    return (field >= 0 && field < 9) ? fieldTypeFlags[field] : 0;
}
...
const char *Ieee80211AddbaRequestDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "int",    // FIELD_startingSequenceNumber
    };
    return (field >= 0 && field < 9) ? fieldTypeStrings[field] : nullptr;
}
...
std::string Ieee80211AddbaRequestDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_startingSequenceNumber: return long2string(pp->getStartingSequenceNumber());
        default: return "";
    }
}
...
bool Ieee80211AddbaRequestDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_startingSequenceNumber: pp->setStartingSequenceNumber(string2long(value)); return true;
        default: return false;
    }
}
