 ...
 * </pre>
 */
class INET_API RSVPPathMsg_Base : public ::inet::RSVPPacket
{
  protected:
    RsvpHopObj_t hop;
    LabelRequestObj_t label_request;
 ...
 * </pre>
 */
class INET_API RSVPPathTear_Base : public ::inet::RSVPPacket
{
  protected:
    RsvpHopObj_t hop;
    SenderTemplateObj_t senderTemplate;
 ...
 * </pre>
 */
class INET_API RSVPPathError_Base : public ::inet::RSVPPacket
{
  protected:
    IPv4Address errorNode;
    int errorCode;
