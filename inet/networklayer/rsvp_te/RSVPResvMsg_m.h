 ...
 * </pre>
 */
class INET_API RSVPResvMsg_Base : public ::inet::RSVPPacket
{
  protected:
    RsvpHopObj_t hop;
    FlowDescriptorVector flowDescriptor;
 ...
 * </pre>
 */
class INET_API RSVPResvTear_Base : public ::inet::RSVPPacket
{
  protected:
    RsvpHopObj_t hop;
    FlowDescriptorVector flowDescriptor;
 ...
 * </pre>
 */
class INET_API RSVPResvError_Base : public ::inet::RSVPPacket
{
  protected:
    RsvpHopObj_t hop;
    IPv4Address errorNode;
