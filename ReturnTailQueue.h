...
#ifndef __INET_RETURNTAILQUEUE_H
#define __INET_RETURNTAILQUEUE_H
...
/**
 * Return-front queue. See NED for more info.
 */
class INET_API ReturnTailQueue : public PassiveQueueBase
{
  protected:
    // configuration
    int frameCapacity;
...
#endif // ifndef __INET_RETURNTAILQUEUE_H
